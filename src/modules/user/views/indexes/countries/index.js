...
class CountryList extends Component {
    ...
    render () {
        ...
        return (
            <Fragment>
                <Breadcrumbs breadCrumbMainTitle={''} breadCrumbTitle={"Countries List"} breadCrumbParent='' breadCrumbActive='' >
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(CountryList)
